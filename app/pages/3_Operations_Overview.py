...
try:
    ...
    with c_chart:
        ...
        render_forecast_interpretation_box(
            ...
            text=f"Freight rates are projected to {fc_trend_str.lower()} over the next 14 days based on {fc_res['selected_model']} model analysis (validation MAE: {format_inr(usd_to_inr(fc_res['metrics']['MAE']))}/tonne)."
        )
